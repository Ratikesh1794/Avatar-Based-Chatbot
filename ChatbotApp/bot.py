...
# openai.organization = "org-3ypOPQquyZ5oiqWt3pgA3K3m"
openai.api_key = "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"
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"D:/AI PA/ChatbotApp/avatar-390004-ea6c57f9ae2b.json"
...
def get_user_personality(user_id):
    with open('D:/AI PA/ChatbotApp/User.csv', 'r') as csvfile:
...
def generate_empathetic_response(user_message, facial_expression, user_personality, max_tokens=200):
    prompt = f'Word limit : 50 words, User data: {user_message}%, Facial Expression: {facial_expression}%, User Personality: {user_personality}%\n\n' \
